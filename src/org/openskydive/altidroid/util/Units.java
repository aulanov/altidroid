...
public class Units implements OnSharedPreferenceChangeListener {
    ...
    public String getUnitsNameShort() {
        int resId;
        if (mPreferred == Type.METRIC) {
    ...
    public CharSequence formatAltitude(int altitude) {
        return toUserUnits(altitude) + " " + getUnitsNameShort();
    }
     ...
     */
    public String formatClimbRate(float speed) {
        ...
        return mContext.getString(resId, toUserUnits(s));
    }
}
