...
public class JumpInfoActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new JumpInfoPagerAdapter(this, getSupportFragmentManager(), mContentObserver);
    ...
    private void deleteCurJump() {
        ...
        new AlertDialog.Builder(this)
            ...
            .setPositiveButton(android.R.string.yes, (dialog, whichButton) -> getContentResolver().delete(LogEntry.Columns.getContentUri(JumpInfoActivity.this),
                                        LogEntry.Columns.ID + "=?",
    ...
    public static class JumpInfoFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            ((TextView) rootView.findViewById(R.id.number)).setText(
                    String.format("%d", proto.getNumber()));
