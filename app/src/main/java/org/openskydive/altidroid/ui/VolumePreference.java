...
public class VolumePreference extends SeekBarPreference implements
    ...
    private class SeekBarVolumizer implements OnSeekBarChangeListener, Runnable {
        ...
        SeekBarVolumizer(Context context, SeekBar seekBar,
                         float initialValue) {
        ...
        void changeVolumeBy(int amount) {
        ...
        void onRestoreInstanceState(VolumeStore volumeStore) {
        ...
        void onSaveInstanceState(VolumeStore volumeStore) {
            if (mLastVolume >= 0) {
