...
public class AlarmEdit extends Activity implements OnSeekListener, TextWatcher,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUnits = findViewById(R.id.units_text);
        if (mAlarm.getType() == Alarm.Type.FREEFALL_DELAY) {
            mUnits.setText(R.string.units_s_short);
        } else {
            mUnits.setText(Units.getInstance(this).getUnitsNameShort(this));
        }
        ...
        mTtsMessage = findViewById(R.id.tts_message);

        mPlayTtsMessage = findViewById(R.id.play_tts_message);
        mPlayTtsMessage.setOnClickListener(this);

        mPickSystemAlarm = findViewById(R.id.pick_system_alarm);
        mPickSystemAlarm.setOnClickListener(this);

        mPickCustomSound = findViewById(R.id.pick_custom_sound);
        mPickCustomSound.setOnClickListener(this);

        mCustomSoundName = findViewById(R.id.custom_sound_name);
        mSystemAlarmName = findViewById(R.id.system_alarm_name);
        ...
        mBuiltInSpinner = findViewById(R.id.builtin_spinner);
    ...
    private void showError(int msgId, Object... formatArgs) {
        ...
        builder.setMessage(getString(msgId, formatArgs)).setNeutralButton(
                R.string.ok, (dialog, which) -> dialog.dismiss());
        builder.create().show();
    }
