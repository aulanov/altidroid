...
public class AltidroidService extends Service implements SkydiveListener {
    ...
    public void onCreate() {
        ...
        mWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "altidroid:wakelock");
    ...
    private void showNotification(String status) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel("altidroid", getString(R.string.app_name), NotificationManager.IMPORTANCE_LOW);
            NotificationManager nm = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
            nm.createNotificationChannel(channel);
            builder.setChannelId("altidroid");
        }
